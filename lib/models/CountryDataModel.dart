...
class CountryModel {
  ...
  CountryModel({required this.capital, required this.pngFlag, required this.countryName, required this.carSigns, required this.carDrivingSide, required this.languages});
